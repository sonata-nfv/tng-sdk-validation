...
class Descriptor(object):
    ...
    def cpu_requirements(self):
        print("CPU requeriments. Number of CPUS: {} Freq of CPUs: {}"
              .format(self.vdu_resource_requirements_cpu_vcpus,
                      self.vdu_resource_requirements_cpu_freq))

    def ram_requirements(self):
        print("RAM requeriments. Amount of RAM: {}"
              .format(self.vdu_resource_requirements_memory_size))
