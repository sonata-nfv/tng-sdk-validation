...
print("DUMP OF RULES: \n"+json.dumps(rules))
run_all(rule_list=rules, defined_variables=ProductVariables(producto),
        defined_actions=ProductActions(producto), stop_on_first_trigger=True)
